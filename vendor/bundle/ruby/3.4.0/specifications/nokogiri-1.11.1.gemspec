...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<hoe-markdown>.freeze, ["~> 1.1".freeze])
  ...
  s.add_development_dependency(%q<rake-compiler-dock>.freeze, ["~> 1.1".freeze])
  s.add_development_dependency(%q<rexical>.freeze, ["~> 1.0.5".freeze])
